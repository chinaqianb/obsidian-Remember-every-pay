...
# use
## English
you need to download this plugin first,and other you also need download the plugin [Charts](https://github.com/phibr0/obsidian-charts)(or the summary function will not work)
## 中文
你需要先下载这个插件，额外的，你需要下载[Charts](https://github.com/phibr0/obsidian-charts)插件(否则月份统计功能无法使用)
